        ...
        <div className="wrapper flex justify-between items-center h-screen w-full px-20 lg:justify-center lg:px-6">
          <div className="content lg:text-center">
            ...
            <h1 className="text-white text-5xl font-bold">
              Hi! I'm Anish Sharma Ghimire
            </h1>
            <p className="text-white py-4 max-w-lg ">
              Experienced Full-Stack MERN Developer with Expertise in Building
              Scalable Web Applications using MongoDB, Express, React, and
              Node.js. Bringing Your Ideas to Life with Clean, Efficient, and
              Dynamic Code."
            </p>
